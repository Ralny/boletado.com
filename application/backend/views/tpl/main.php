...
<div class="page-header">
	...
	<div class="page-header-top">
		<div <?= $layout_class ?>>
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="<?= base_url() ?>"><img src="<?= base_url() ?>assets/backend/zata/imgs/logo-default.png" width="170" heigth="50" alt="logo" class="logo-default"></a>
			</div>
			<!-- END LOGO -->
